...
class Stores(models.Model):
    ...
    FaceBook=models.CharField(max_length=100,null=True,blank=True)    #URLField(null=True)
    Instagram=models.CharField(max_length=100,null=True,blank=True)    #URLField(null=True)
    Twitter=models.CharField(max_length=100,null=True,blank=True)    #URLField(null=True)
    VideoLink=models.CharField(max_length=100,null=True,blank=True)    #URLField(null=True)
